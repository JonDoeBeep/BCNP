...
private:
    ...
    static constexpr std::size_t kMaxPayloadSize = kHeaderSizeV3 + (kDriveCmdSize * kMaxMessagesPerPacket);
    static constexpr std::size_t kMaxPacketSize = kMaxPayloadSize + kChecksumSize;
